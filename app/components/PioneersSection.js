...
{ rank: 1, name: "Lesi_Crypt", points: 9300, contributions: 9 },
{ rank: 2, name: "Adex_014", points: 5700, contributions: 4 },
{ rank: 3, name: "Silver/JudgmentSheep", points: 3100, contributions: 3 },
{ rank: 4, name: "Sahmiex", points: 2600, contributions: 2 },
{ rank: 5, name: "Dynimite_590", points: 2200, contributions: 1 }
]
...
{ label: "Active Pioneers", value: "11", icon: "👥" },
{ label: "Total Points", value: "32300", icon: "⭐" },
...
onClick={() => {
if (tab.id === 'submit') {
// Open Google Form directly when clicking Submit Work tab
...
<div className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center flex-shrink-0 text-blue-400 font-bold">{index + 1}</div>
...
<p className="text-gray-300 mb-4">If you earn <span className="text-blue-400 font-bold">10,000 points</span> and total is <span className="text-purple-400 font-bold">500,000 points</span>:</p>
...
<p className="text-center text-gray-400 text-sm mt-4">The more you contribute, the more you earn!</p>
</div>
</motion.div>
</div>
)}
...
<span className="text-yellow-400 font-bold">{pioneer.points.toLocaleString()}</span>
</td>
<td className="p-4 text-right text-gray-400">{pioneer.contributions}</td>
</motion.tr>
))}
</tbody>
</table>
...
<p className="mt-2">Your position will appear here after your first contribution is verified</p>
</div>
</motion.div>

{/* Link to Full Spreadsheet */}
<motion.div
className="quantum-card mt-8"
whileHover={{ scale: 1.01 }}
>
<h3 className="text-xl font-bold mb-4 text-center quantum-text-gradient">📊 Full Leaderboard</h3>
<div className="bg-gray-800/30 rounded-lg p-6 text-center">
<p className="text-gray-300 mb-4">View the complete leaderboard with all pioneers</p>
<motion.button
...
<h3 className="text-3xl font-bold mb-4 quantum-text-gradient">Ready to Quantum Leap?</h3>
