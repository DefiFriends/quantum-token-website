...
<h3 className="text-2xl font-bold mb-6 quantum-text-gradient">QTM Smart Contract</h3>
...
<h3 className="text-2xl font-bold mb-6 quantum-text-gradient">Contract Address</h3>
...
<div className="w-8 h-8 bg-blue-500 text-white flex items-center justify-center text-sm font-bold">
1
</div>
</div>
...
<div className="w-8 h-8 bg-green-500 text-white flex items-center justify-center text-sm font-bold">
2
</div>
</div>
...
<div className="w-8 h-8 bg-purple-500 text-white flex items-center justify-center text-sm font-bold">
3
</div>
</div>
